# This data set and a list of other similar ones are given here:
#	http://www3.ntu.edu.sg/home/elhchen/data.htm
# The specific website for the Leukemia data set is located here:
...
# TODO: Change the name of git repos from "data-leukemia" to "data-microarray"